...
import net.czqu.taskmaster.core.constant.enums.BankType;
import net.czqu.taskmaster.core.dto.ExchangesDTO;
import net.czqu.taskmaster.core.dto.ICBCDTO;
import net.czqu.taskmaster.core.utils.HttpClientUtil;
import net.czqu.taskmaster.core.dto.ICBCGetDTO;
import net.czqu.taskmaster.core.utils.DateTimeUtil;
...
public class ExchangeService {
    ...
    private ExchangesDTO ICBCDTOToExchangesDTO(ICBCDTO item) {
        ...
        exchangesDTO.setBankId((byte) BankType.ICBC.getId());
        return exchangesDTO;
    }
    ...
    public List<Exchanges> getLastData(int num) {
        ...
        List<Exchanges> exchangesList=exchangesMapper.selectByExample(ExchangesExample.newAndCreateCriteria()
                .example().limit(num).orderBy(Exchanges.Column.publishTime.desc()));
        log.info("size:  "+exchangesList.size());
